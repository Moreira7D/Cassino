...
trait PlayFiverTrait
{
    ...
    public static function playFiverLaunch($id, $demo)
    {
        ...
        // Tenta obter o saldo do agente
        $response = Http::withOptions([
            'curl' => [
                CURLOPT_IPRESOLVE => CURL_IPRESOLVE_V4,
            ],
        ])->post("https://api.playfivers.com/api/v2/balance", [
        ...
        if ($response->successful()) {
            ...
            // Atualiza o saldo do agente no banco de dados
            $gamesKey = GamesKey::first();
            if ($gamesKey) {
                $gamesKey->update(['saldo_agente' => $data['data']['balance']]);
            }
        }
